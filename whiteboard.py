...
# Want to count how many absents they have total has to be less than 2 days 2> True
# Want to count how many Lates they have consecutive 3< False
...
def solution(s):
    ...
    # Or 
def solution(attendence):
    return 'LLL' not in attendance and attendance.count('A') <2
